...
Last modified: Sun Oct 21 00:37:03 2018
"""
...
path = "/Users/shanshangao/Google_Drive_BNL/tmp/ledge/10mvperus/"
for root, dirs, files in os.walk(path):
    break

mv10 = [ [10, "001"], [20, "002"], [30,"003"],   [40,"004"],   [50,"005"], 
         [80,"006"],  [100,"007"], [150, "008"], [200, "009"], [400,"011"], 
         [500,"012"], [600,"013"], [700,"014"],  [800, "015"], [900, "016"], 
...
plt.grid()
plt.tight_layout( rect=[0.05, 0.05, 0.95, 0.95])
plt.savefig("./10mVperus_2000mV.png")
plt.close()
...
fig = plt.figure(figsize=(12,8))
plt.scatter(fcs[0:plen], areas, c = 'r', marker = 'x' )
...
plt.grid()
plt.tight_layout( rect=[0.05, 0.05, 0.95, 0.95])
plt.savefig("./10mVperus_area.png")
plt.close()
