...
Last modified: Sun Oct 21 00:45:41 2018
"""
...
path = "/Users/shanshangao/Google_Drive_BNL/tmp/ledge/20mvperus/"
for root, dirs, files in os.walk(path):
    break

mv10 = [ [10, "001"], [20, "002"], [40,"003"],   [60,"004"],   [80,"005"], 
         [100,"006"],  [160,"007"], [200, "008"], [300, "014"], [400,"009"], 
         [600, "010"], [800, "011"], [1000,"012"], [2000,"013"] 
        ]
...
plt.title( "24 fC/us", fontsize = 16 )
plt.ylabel("( ADC output - Pedestal ) / bin", fontsize = 16 )
plt.ylim([-100,2000])
plt.xlabel("ADC ticks", fontsize = 16 )
plt.xlim([0,plt_smps])
...
plt.grid()
plt.tight_layout( rect=[0.05, 0.05, 0.95, 0.95])
plt.savefig("./20mVperus_2000mV.png")
plt.close()
...
plt.grid()
plt.tight_layout( rect=[0.05, 0.05, 0.95, 0.95])
plt.savefig("./20mVperus_area.png")
plt.close()
